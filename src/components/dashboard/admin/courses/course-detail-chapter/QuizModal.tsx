...
const QuizModal: React.FC<QuizModalProps> = ({ quiz, index, onClose }) => {
  return (
    ...
    >
      ...
      overflow-hidden relative animate-in zoom-in-95 duration-200"
      >
        <div className="p-8">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  font-medium focus:outline-none bg-gray-50"
                />
              </div>
              <select
                disabled
                className="px-3 py-1.5 border border-gray-300 rounded text-sm font-medium 
                bg-gray-50 text-gray-700 appearance-none min-w-35"
              >
          ...
          <div className="mb-6">
            ...
            text-gray-900 text-sm bg-white min-h-20"
            >
              {quiz.question}
            </div>
          </div>
