      ...
      <div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          {data.videoPreview ? (
            ...
            border border-dashed border-gray-300 mb-6"
            >
              <img
        ...
        <div>
          ...
          <div className="space-y-3">
            {data.quizzes.map((quiz, index) => (
              <div
                key={quiz.id}
                className={`${fieldWrapper} flex items-center justify-between 
                hover:border-blue-400 transition-colors cursor-pointer group`}
              ...
              >
                ...
                <button
                  ...
                  hover:bg-blue-50 rounded-full transition-all"
                  onClick={(e) => {
                    e.stopPropagation();
