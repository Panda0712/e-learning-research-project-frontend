    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          ...
          {data.introVideo ? (
            <div
              className="relative w-full h-72 bg-slate-900 rounded-lg overflow-hidden flex 
            ...
            >
              ...
              <PlayCircle
                ...
                group-hover:scale-110 transition-transform drop-shadow-lg"
              />

              <div
                className="absolute bottom-0 left-0 w-full p-3 bg-linear-to-t 
              from-black/80 to-transparent text-center text-white text-xs font-medium"
              >
            ...
            <div
              className="h-48 bg-gray-50 rounded-lg border border-dashed 
            border-gray-300 flex items-center justify-center text-gray-400"
            >
              No video uploaded
            </div>
          )}
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          ...
          <div
            className="w-full h-56 bg-gray-50 rounded-lg border border-dashed 
          border-gray-300 flex items-center justify-center p-2"
          >
            {data.introImage ? (
              <img
                src={data.introImage}
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="flex flex-wrap items-center gap-2 px-4 py-3 border-b border-gray-200 bg-gray-50">
            <button
              className="flex items-center gap-1 bg-white border border-gray-300 
            rounded px-3 py-1 text-sm text-gray-700 hover:bg-gray-50"
            >
          ...
          <div
            className="p-6 text-gray-700 text-sm leading-relaxed min-h-62.5 prose prose-sm max-w-none"
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          ...
          border border-gray-200 rounded-lg text-gray-900 cursor-pointer hover:border-blue-500 transition-colors"
          >
            ...
            {data.tags && data.tags.length > 0 ? (
              data.tags.map((tag) => (
                <span
                  ...
                  text-gray-700 text-xs font-bold rounded-full border border-gray-200"
                >
                  {tag}
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          ...
          <div
            className="flex justify-between items-center w-full px-4 py-3 bg-white 
          border border-gray-200 rounded-lg text-orange-500 cursor-pointer 
        ...
        <div className="flex justify-end pt-2">
          ...
          hover:underline hover:text-blue-700 transition-colors"
          >
            Add Section +
          </button>
        </div>
