            ...
            <div className="lg:col-span-1">
              <div className="rounded-xl bg-gray-50 p-6">
                ...
                <div className="mb-6 flex justify-center gap-3">
                  ...
                  bg-white text-blue-600 shadow-sm transition-all hover:bg-blue-600 hover:text-white"
                  >
                    <FaFacebookF size={18} />
                  </button>
                  <button
                    className="flex h-10 w-10 items-center justify-center rounded-lg 
                  bg-white text-blue-400 shadow-sm transition-all hover:bg-blue-400 hover:text-white"
                  >
                    <FaTwitter size={18} />
                  </button>
                  <button
                    className="flex h-10 w-10 items-center justify-center rounded-lg 
                  bg-white text-blue-500 shadow-sm transition-all hover:bg-blue-500 hover:text-white"
                  >
                    <FaSkype size={18} />
                  </button>
                  <button
                    className="flex h-10 w-10 items-center justify-center rounded-lg 
                  bg-white text-blue-700 shadow-sm transition-all hover:bg-blue-700 hover:text-white"
                  >
                    ...
                    {skills.map((skill, index) => (
                      <div key={index}>
                        ...
                        <div className="h-2 w-full overflow-hidden rounded-full bg-gray-200">
                          <div
                            className="h-full rounded-full bg-linear-to-r from-blue-400 
