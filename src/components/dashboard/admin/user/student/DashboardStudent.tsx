...
const DashboardStudent = () => {
  ...
  }>({ isOpen: false, action: "block", studentId: null });
    ...
    <div className="w-full">
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {students.map((student) => (
              <tr
                key={student.id}
                className="border-b border-[#E8E8F4] last:border-b-0"
              >
                ...
                <td className="px-6 py-4">
                  <p className="font-poppins text-sm text-[#000000]">
                    {student.name}
                  </p>
                ...
                <td className="px-6 py-4">
                  {student.status === "Active" ? (
                    <span
                      className="inline-flex items-center gap-1.5 rounded-full bg-green-50 
                    px-3 py-1 font-poppins text-xs font-medium text-green-600"
                    >
                    ...
                    <span
                      className="inline-flex items-center gap-1.5 rounded-full bg-[#FC6441]/10 
                    px-3 py-1 font-poppins text-xs font-medium text-[#FC6441]"
                    >
                ...
                <td className="relative px-6 py-4">
                  ...
                  {openMenuId === student.id && (
                    <div
                      className="absolute right-8 top-12 z-10 w-32 overflow-hidden rounded-lg 
                    bg-white shadow-lg ring-1 ring-black/5"
                    >
                      <button
                        onClick={() => handleView(student.id)}
                        className="flex w-full items-center gap-2 px-4 py-2 font-poppins text-sm 
      ...
      <div className="mt-6 flex items-center justify-center gap-2">
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#E8E8F4] 
          bg-white font-poppins text-sm text-[#333931] hover:bg-[#F5F7FA]"
        >
          &lt;
        </button>
        {[1, 2, 3].map((page) => (
          <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-lg font-poppins text-sm ${
              currentPage === page
                ...
                : "border border-[#E8E8F4] bg-white text-[#333931] hover:bg-[#F5F7FA]"
            }`}
          >
            {page}
          </button>
        ...
        <button
          ...
          border-[#E8E8F4] bg-white font-poppins text-sm text-[#333931] hover:bg-[#F5F7FA]"
        >
          &gt;
        </button>
      </div>
