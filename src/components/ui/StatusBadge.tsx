...
import type { CouponStatus } from "../../pages/Dashboard/Lecturer/DashboardCreateCourse/DashboardPromotion";
import type { CourseStatus } from "../dashboard/lecturer/my-courses/DashboardCoursesTable";
      ...
      <span className="leading-none">
        {type === "course"
          ...
          : type === "order"
            ...
            : type === "curriculum"
              ? curriculumStatus.charAt(0).toUpperCase() +
                curriculumStatus.slice(1)
