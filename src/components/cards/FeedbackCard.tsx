...
const FeedbackCard = ({
  ...
  return (
    <div className="flex flex-col p-5 shadow-[0_0_20px_0_rgba(0,0,0,0.05)] rounded-[20px]">
      ...
      <img src={Comma} className="object-cover w-3.75 h-7.5 ml-1" alt="" />
      ...
      <div className="flex items-center gap-5 pt-4 mx-5 border-t-2 mt-4 mb-4 border-[#B1B3B6]">
        ...
        relative w-18.75 h-18.75 border-2 border-[#0166FF]"
        >
          <img
            src={avatar}
            className="object-cover w-18.25 h-18.25 rounded-full"
            alt=""
          />
        </div>
