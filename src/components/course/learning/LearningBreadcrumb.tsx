...
const LearningBreadcrumb = ({ category, title }: Props) => {
  return (
    <div className="bg-[#F5F7FA] py-3 border-b border-gray-200">
      <div className="max-w-400 mx-auto px-4 lg:px-8 text-xs text-gray-500 flex items-center gap-2 font-poppins">
        ...
        <ChevronRight size={12} />
        <span className="text-gray-700 font-medium truncate max-w-37.5 sm:max-w-md">
          {title}
        </span>
      </div>
    </div>
