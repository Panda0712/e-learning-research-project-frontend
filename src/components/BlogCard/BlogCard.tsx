      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex items-center gap-6 text-gray-500 text-sm mb-4">
            <div className="flex items-center gap-2 "> 
                ...
                <span className='font-medium font-poppins text-[#333931] text-[10px]'>{data.date}</span>
            </div>
            
            <div className="flex items-center gap-2 text-gray-500">
                <User size={18} className='text-[#FF6B6B]' />
                <span className='font-medium font-poppins text-[#333931] text-[10px]'>{data.author}</span>
            </div>
        </div>
