      ...
      <div className="flex gap-4 mb-6 relative z-20">
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown
              size={16}
              className={`transition-transform shrink-0 ${activeDropdown === "course" ? "rotate-180" : ""}`}
            />
          </button>
            ...
            >
              <ul className="py-1 text-sm text-gray-700">
                <li
                  ...
                  className={`px-4 py-2.5 hover:bg-gray-50 cursor-pointer ${filterCourse === "All Courses" ? "bg-blue-50 text-blue-600 font-medium" : ""}`}
                >
                  All Courses
                </li>
                {UNIQUE_COURSES.map((course) => (
                  <li
                    ...
                    className={`px-4 py-2.5 hover:bg-gray-50 cursor-pointer truncate ${filterCourse === course ? "bg-blue-50 text-blue-600 font-medium" : ""}`}
                    title={course}
                  >
                    {course}
                  </li>
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown
              size={16}
              className={`transition-transform shrink-0 ${activeDropdown === "sort" ? "rotate-180" : ""}`}
            />
          </button>
          {activeDropdown === "sort" && (
              ...
              <ul className="py-1 text-sm text-gray-700">
                {SORT_OPTIONS.map((option) => (
                  <li
                    ...
                    className={`px-4 py-2.5 hover:bg-gray-50 cursor-pointer ${sortOption === option ? "bg-blue-50 text-blue-600 font-medium" : ""}`}
                  >
                    {option}
                  </li>
                ))}
          ...
          <div className="p-4 flex justify-center items-center gap-2 border-t border-gray-100">
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`w-8 h-8 rounded-md text-sm font-medium ${currentPage === i + 1 ? "bg-blue-600 text-white" : "hover:bg-gray-50 text-gray-600"}`}
              >
                {i + 1}
              </button>
            ))}
