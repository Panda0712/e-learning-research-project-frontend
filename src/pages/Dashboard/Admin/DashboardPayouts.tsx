...
const DashboardPayouts = () => {
  ...
  const historyData: PayoutItem[] = Array.from({ length: 15 }, (_, i) => ({
    ...
    name:
      i % 2 === 0
        ? `Nguyen Van ${String.fromCharCode(65 + i)}`
        : `Tran Thi ${String.fromCharCode(65 + i)}`,
    ...
    <div className="px-6 pb-6 pt-0 min-h-screen font-poppins relative">
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="relative mt-4">
          ...
          {showConfigModal && (
            <div
              className="absolute right-0 top-full mt-2 z-50 w-87.5 bg-white rounded-xl 
            shadow-2xl border border-gray-100 animate-scale-up p-6 origin-top-right"
            >
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  focus:border-blue-500 text-gray-700 font-medium"
                />
              </div>
              <div className="flex justify-end gap-3">
                <button
                  ...
                  font-bold hover:bg-gray-50 text-sm"
                >
                  Cancel
                </button>
                <button
                  onClick={() => setShowConfigModal(false)}
                  className="px-4 py-2 rounded-lg bg-[#FFD130] text-black 
                  font-bold hover:bg-[#eec225] shadow-sm text-sm"
                >
                  Save Configuration
                </button>
              </div>
        ...
        <div className="flex justify-center mt-6">
          ...
          >
            ...
            <button
              ...
              className="relative inline-flex items-center rounded-r-md px-3 
              py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 
