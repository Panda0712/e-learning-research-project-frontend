      ...
      <div className="px-8 py-8 max-w-5xl mx-auto">
        ...
        <div className="bg-[#F9FAFB] rounded-xl p-8 border border-gray-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                readOnly
                className="w-full bg-white border border-gray-200 rounded-lg p-3 
                text-gray-700 text-sm focus:outline-none resize-none"
              />
            </div>
            <div className="md:col-span-2">
              <label className="block text-xs font-bold text-gray-500 mb-1">
              ...
              <div className="flex items-center gap-3 bg-white p-3 rounded-lg border border-gray-200">
                ...
                <button
                  className="text-blue-600 text-sm font-bold ml-auto 
          ...
          <div className="flex gap-4 mt-8">
            <button
              onClick={onApprove}
              className="px-8 py-3 bg-[#704FE6] text-white rounded-full 
              font-bold hover:bg-[#5F3DD4] transition-all shadow-lg"
            >
              Approve
            </button>
            <button
              onClick={onReject}
              className="px-8 py-3 bg-[#FF4444] text-white rounded-full 
              font-bold hover:bg-[#dd3333] transition-all shadow-lg"
            >
              Reject
            </button>
          </div>
...
const DashboardInstructorRequests = () => {
  const [allRequests, setAllRequests] = useState<InstructorRequest[]>(
    Array(15)
      ...
      .map((_, i) => ({
        ...
        professionalTitle:
          i % 2 === 0 ? "User Interface" : "Systems and Databases",
        ...
        bioExperience: "Experience stories...",
        cvFileName: "CV.pdf",
      })),
  );
            ...
            {currentItems.map((item) => (
              ...
              >
                ...
                <td className="p-4 text-right relative">
                  ...
                  {openMenuId === item.id && (
                    <div
                      className="absolute right-8 top-10 w-36 bg-white rounded-lg shadow-xl 
                    border border-gray-100 z-50 overflow-hidden text-left animate-fade-in"
                    >
                      <button
                        onClick={() => {
                          setSelectedRequest(item);
                      ...
                      {activeTab === "requests" && (
                        <>
                          <button
                            ...
                            className="w-full flex items-center gap-2 px-4 py-2.5 text-sm 
                            text-green-600 hover:bg-green-50 font-bold transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="w-full flex items-center gap-2 px-4 py-2.5 text-sm 
                            text-red-600 hover:bg-red-50 font-bold transition-colors"
                          >
                            <X size={16} /> Reject
                          </button>
                        </>
  ...
  function renderConfirmModal() {
    return (
      ...
      >
        <div
          className="bg-white rounded-xl p-8 w-100 shadow-2xl 
        ...
        >
          ...
          <p className="text-gray-500 text-sm mb-8 leading-relaxed">
            Are you sure you want to {actionType} this request? This will move
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              bg-[#FFD130] hover:bg-[#eec225] shadow-md transition-all"
            >
              Confirm
            </button>
          </div>
